...
The catalog data can be accessed locally in the corresponding folder inside [*catalog_data*](https://github.com/castro-gzlz/mr-plotter/tree/main/catalog_data). We try to mantain the catalogs as much updated as possible, but if you do not clone the repository frequently we recommend to download the most updated catalogs from: <br />
