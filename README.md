...
If your favorite model is not yet included in *mr-plotter*, you have any problem when using the package, or you think it can be improved in any way, don't hesitate to contact me at [acastro@cab.inta-csic.es](acastro@cab.inta-csic.es). 
