...
| name_p1<sup>**2**</sup> | Any name (e.g. TOI-244 b) | Name of your planet 1 to be plotted inside a box next to the planet location |
...
**<sup>2</sup>** These three options should be specified only if you want to include text boxes next to your planets indicating their names.
