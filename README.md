...
| low_density_superEarths | True of False | Plot the low-density super-Earths region shown in [Castro-González et al. (2023)](https://ui.adsabs.harvard.edu/abs/2023arXiv230504922C/abstract). **Default:** False|
| densities_below_pure_iron | True of False | Include a grey shade below the 100% iron model by [Zeng et al. (2019)](https://ui.adsabs.harvard.edu/abs/2019PNAS..116.9723Z/abstract). **Default**: True |
