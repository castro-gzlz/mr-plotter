...
**<sup>3</sup>** All the possible values to color code your plot: **disc_year** (Discovery year), **pl_orbper** (Orbital period in days), **pl_orbsmax** (Semi-major axis  in AU, **st_met** (Stellar metallicity in dex);  
