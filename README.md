...
### Example 3: The PlanetS catalog, empirical M-R relationships, and color coding based on homogeneously computed Transmission and Emission Spectroscopy metrics (TSM and ESM).
