...
| Option | Possible values | Description |
| ------------- | ------------- | ------------- |
| color_min | Any | Minimum **value** for the color-coded plots. If not specified, mr-plotter will choose the median of the 5% minimum values |
| color_max | Any | Maximum **value** for the color-coded plots. If not specified, mr-plotter will choose the median of the 5% maximum values |
