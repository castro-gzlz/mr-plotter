...
**<sup>3</sup>** All the possible values to color code your plot: **disc_year** ⟶ Discovery year | **pl_orbper** ⟶ Orbital period (days) | **pl_orbsmax** ⟶ Semi-major axis (AU) |  **st_met** ⟶ Stellar metallicity (dex) | 
