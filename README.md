...
Mister plotter is a **user-friendly** Python tool designed to produce **paper-quality mass–radius diagrams**, based on a **broad selection of** [models](#models--include-theoretical-models) of **planetary interiors and atmospheres**.
