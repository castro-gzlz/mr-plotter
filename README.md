...
```
![example2_joint](https://github.com/user-attachments/assets/6d50f736-0aa6-489d-9680-188307f43dce)
...
**<sup>2</sup>** If a non-numerical color code is chosen (e.g. disc_year, disc_facility, etc), the grups to display and their colors have to be defined (see how [here]()).  </sub>
