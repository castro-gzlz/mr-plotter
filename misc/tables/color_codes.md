...
| `pl_insol` | Insolation flux | $\rm S_{\oplus}$ |
...
| `st_rad` | Stellar radius | $\rm R_{\odot}$ |
| `st_mass` | Stellar mass | $\rm M_{\odot}$ |
| `st_met` | Stellar metallicity | dex |
| `st_logg` | Stellar surface gravity | dex |
| `st_lum` | Stellar luminosity | $\log(\rm L_{\odot})$ |
...
| `sy_kmag` | $K_{\rm s}$ magnitude | mag |
| `sy_gaiamag` | $Gaia$ magnitude | mag |
...
| Code | Description | Units |
|------|-------------|-------|
| `pl_insol_PlanetS` | Insolation flux | $\rm S_{\oplus}$ |
...
| `st_lum_gaia` | Stellar luminosity | $\log(\rm L_{\odot})$ |
